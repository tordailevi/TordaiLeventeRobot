...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));
        ...
        jLabel1.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));

        txtVelSzam1.setEditable(false);
        txtVelSzam1.setText("10");
        txtVelSzam1.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));
        ...
        jLabel2.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));

        txtVelSzam2.setEditable(false);
        txtVelSzam2.setText("1");
        txtVelSzam2.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));

        jPanel5.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));
        ...
        btnGeneral.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));
        ...
        numMin.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));

        numMax.setModel(new javax.swing.SpinnerNumberModel(10, 1, 10, 1));
        numMax.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));
        ...
        jButton1.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(102, 102, 255)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        jTextArea1.append("A három robotunk tippel egy-egy számot!");
        int szam;
        ...
        jTextArea1.append("A kitalálandó szám: " + szam);
        
        jTextArea1.append("1. Robot tippje: " + tipp1);
        
        jTextArea1.append("2. Robot tippje: " + tipp2);
        
        jTextArea1.append("3. Robot tippje: " + tipp3);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void txtVelSzam1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtVelSzam1ActionPerformed
        /*3 robot tippel egyet-egyet*/
        int szam;
        int tipp1, tipp2, tipp3;
        ...
        jTextArea1.append("Az első Robot tippje: " + tipp1);
        
        jTextArea1.append("A második Robot tippje: " + tipp2);
        
        jTextArea1.append("A harmadik Robot tippje: " + tipp3);
        
        boolean voltTalalat = false;
        
        if (tipp1 == szam){
            voltTalalat = true;
            jTextArea1.append("Az első Robot eltalálta!");
        }
        if (tipp2 == szam){
            voltTalalat = true;
            jTextArea1.append("A második Robot eltalálta!");
        }
        if (tipp3 == szam){
            voltTalalat = true;
            jTextArea1.append("A harmadik Robot eltalálta!");
        }
        if (!voltTalalat){
            jTextArea1.append("Egyik Robot sem találta el a kitalálandó számot!");
        }
        
        
        /*Egy robot tippel 3x*/
        int szam1 = (int) (Math.random() *10) +1;
        int tipp = (int) (Math.random() *10) +1;
        
        jTextArea2.append("A kitalálandó szám: " +szam1);
        jTextArea2.append("Az 1. tippünk: " +tipp);
        
        if (tipp == szam1){
            jTextArea2.append("Hát ez gyors volt, elsőre sikerült eltalálni!");
        }else{
            tipp = (int) (Math.random() *10) +1;
            jTextArea2.append("A 2. tipp: " + tipp);
            if(tipp == szam1){
                jTextArea2.append("Másodikra meglett!");
            }else{
                tipp = (int) (Math.random() *10) +1;
                jTextArea2.append("A 3. tipp: " + tipp);
                if(tipp == szam1){
                    jTextArea2.append("Harmadikra sikerült eltalálni!");
                }else{
                    jTextArea2.append("Nem sikerült eltalálni a kitalálandó számot!");
                }
            }
        }
